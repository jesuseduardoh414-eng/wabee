...
export class ErrorBoundary extends Component<Props, State> {
    ...
    public render() {
        if (this.state.hasError) {
            return (
                <div className="min-h-screen bg-[#0a0a05] text-white flex flex-col items-center justify-center p-6 text-center">
                    <div className="w-20 h-20 bg-red-500/10 border border-red-500/20 rounded-3xl flex items-center justify-center text-red-500 mb-6 shadow-2xl shadow-red-500/5">
                    ...
                    <div className="bg-[#121208] border border-[#2a2a1a] rounded-2xl p-4 mb-8 max-w-xl w-full text-left overflow-auto">
