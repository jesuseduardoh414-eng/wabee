                ...
                <form onSubmit={handleSubmit} className="p-8 space-y-6">
                    ...
                    <div className="bg-[var(--brand-primary)]/5 border border-[var(--brand-primary)]/20 p-5 rounded-2xl flex gap-4">
                        ...
                        <p className={`${T.helperText} ${S.meta} text-[color:var(--text-muted)] leading-relaxed`}>
                            <strong className="text-[color:var(--brand-primary)] font-black uppercase tracking-tighter">Nota:</strong> No necesitas ingresar el Access Token. El sistema usará automáticamente la sesión vinculada durante el proceso de OAuth de Meta.
                        </p>
                    </div>
