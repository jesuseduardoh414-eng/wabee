...
const COPY = {
    title: 'Contactos',
    subtitle: 'Gestiona tus contactos, segmentos y etiquetas.',
    ...
    specificGroup: 'Grupo',
    closeView: 'Cerrar',
    dynamicView: 'Segmento',
    smartSegment: 'Filtrado por segmento',
    leaveSegment: 'Quitar filtro',
    searchPlaceholder: 'Buscar por nombre, teléfono o correo...',
    allEcosystem: 'Todos',
    newEntry: 'Nuevo',
    qualifiedLead: 'Lead',
    activeLink: 'Activo',
    loyalCustomer: 'Cliente',
    inactive: 'Inactivo',
    identity: 'Nombre',
    telephony: 'Teléfono',
    protocol: 'Estado',
    ...
    commands: 'Acciones',
    scanning: 'Cargando…',
    noRecords: 'Sin contactos',
    noName: 'Sin nombre',
    noEmail: 'Sin correo',
    noTags: 'Sin etiquetas',
    hiddenSegments: 'Más segmentos',
    detailTitle: 'Detalle del contacto',
    viewDetail: 'Ver detalle',
    accessing: 'Cargando…',
    chat: 'Chat',
    population: (total: number) => `${total} contactos`,
    previous: '← Anterior',
    next: 'Siguiente →',
    whatsappChannel: 'Canal WhatsApp',
    multipleChannels: 'Tienes varios canales. Elige desde cuál enviar.',
    abort: 'Cancelar',
    ensureConnection: 'Confirmar',
    invalidPhone: 'Este contacto no tiene un teléfono válido.',
    loginRequired: 'Por favor inicia sesión.',
    noChannels: 'No tienes canales de WhatsApp conectados. Conecta un número en Configuración.',
} as const;
        ...
        <div className="mx-auto min-h-screen max-w-7xl space-y-8 bg-[var(--bg-page)] px-4 py-6 text-left sm:space-y-10 sm:px-6 sm:py-8 lg:px-8">
            <header className="flex flex-col gap-5 lg:flex-row lg:items-end lg:justify-between">
                <div className="max-w-xl space-y-2">
                    <h1 className={`${T.pageTitle} ${S.displayMd}`}>{COPY.title}</h1>
